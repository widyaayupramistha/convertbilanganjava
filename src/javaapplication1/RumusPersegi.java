 ...
 * @author Dev10
 */
public class RumusPersegi extends javax.swing.JFrame {

    /**
     * Creates new form RumusPersegi
     */
    public RumusPersegi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Menghitung Rumus Persegi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RumusPersegi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RumusPersegi().setVisible(true);
            }
        });
    }
